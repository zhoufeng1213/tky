...
class DatePicker extends BaseWheelPick {
    ...
    private Integer[] yearArr, mothArr, dayArr, hourArr, minutArr, secndArr;
    ...
    public void init() {
        ...
        setWheelListener(secondView, secndArr, false);
        ...
        secondView.setCurrentItem(datePicker.findIndextByValue(datePicker.getToady(DatePickerHelper.Type.SECOND), secndArr));
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        ...
        int second = secndArr[secondView.getCurrentItem()];
