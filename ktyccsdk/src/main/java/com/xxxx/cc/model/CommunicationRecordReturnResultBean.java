 ...
 * @moduleName
 */
public class CommunicationRecordReturnResultBean {
    ...
    public static class PageBean {
        ...
        private List<CommunicationRecordResponseBean> content;
        ...
        public List<CommunicationRecordResponseBean> getContent() {
            return content;
        }

        public void setContent(List<CommunicationRecordResponseBean> content) {
