...
public class ButtomCallDialog extends Dialog {
    ...
    public ButtomCallDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public ButtomCallDialog create() {
            final ButtomCallDialog dialog = new ButtomCallDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
